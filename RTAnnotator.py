...
class Window(QWidget):
    ...
    def init_ui(self):
        ...
        self.shortcutsBtn = QPushButton(" Help")
        ...
        self.numLabel.setGeometry(QRect(80, 50, 300, 150))
        ...
        # Create 2 separation lines
        self.separationLine = QFrame()
        self.separationLine.setGeometry(QRect(420, 110, 16, 50))
        self.separationLine.setFrameShape(QFrame.VLine)
        self.separationLine.setFrameShadow(QFrame.Sunken)

        self.separationLine2 = QFrame()
        self.separationLine2.setGeometry(QRect(420, 110, 16, 10))
        self.separationLine2.setFrameShape(QFrame.VLine)
        self.separationLine2.setFrameShadow(QFrame.Sunken)
        ...
        self.spacerItem3 = QSpacerItem(0, 200)
        self.spacerItem4 = QSpacerItem(0, 180)
        self.spacerItem5 = QSpacerItem(300, 0)
        ...
        #self.hline = self.canvas.axes.axhline(y=self.VerticalSlider.value(), color='green',linestyle=":")
    ...
    def init_layout(self):
        ...
        middle_hbox.addWidget(self.separationLine)
        middle_hbox.addItem(self.spacerItem5)
        middle_hbox.addWidget(self.separationLine2)
    ...
    # Ignore the following 3 methods. They are not used right now. They might be used later.
    def gen1(self):
        """ ignore this method. It is not used right now. It may be used later"""
        i = 0.5
        while(True):
            yield i
            i += 0.1
    ...
    def sliderValueChanged(self, i):
        ...
        self.hline = self.canvas.axes.axhline(y=value, color='green',linestyle=":")
    ...
    def update_line(self, i):
        ...
        #self.line2 = self.canvas.axes.plot(self.xValues, self.yValues,"gray",linestyle=":")
    ...
    def play_video(self):
        ...
        if self.mediaPlayer.state() == QMediaPlayer.PlayingState:
            ...
            self.interval_value = 30/float(self.speedCombo.currentText())
            ...
            if self.neverPlayed:
                ...
                self.ani = FuncAnimation(self.canvas.figure, self.update_line, blit = True, interval=self.interval_value)
                #self.ani = FuncAnimation(self.canvas.figure, self.update_line, self.gen2, interval=self.interval_value)
            ...
            if self.ani != None:
                self.ani.setInterval(self.interval_value)
                #print("interval set")
    ...
    def shortcuts(self):
        ...
        message.setText("How to annotate:\n"
                        "Move the mouse up and down between the two vertical lines in the middle.\n\n\n"
                        "Keyboard shortcuts:\n\n"
                        "CTRL+S\t\tSave\n"
                        "CTRL+O\t\tOpen video\n"
